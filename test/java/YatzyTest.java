...
public class YatzyTest {
    ...
    @Test
    @Tag("twoPair")
    @DisplayName("verifica si hay dos pares de dados con el mismo valor y devuelve la puntuación correspondiente")
    public void twoPair() {
    ...
    @Test
    @Tag("threeOfAKind")
    @DisplayName("verifica si hay al menos tres dados con el mismo valor y devuelve la puntuación correspondiente")
